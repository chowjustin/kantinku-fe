    ...
    >
      ...
      <div className="md:hidden z-50">
        <Link href={"/"} className="flex items-center gap-2 ml-10">
          <NextImage
            ...
            alt="Logo Kantinku"
            className="flex max-w-[40px] items-center"
          />
          <p className="text-black font-bold text-xl md:hidden">KantinKu</p>
        </Link>
        <div
      ...
      <UnstyledLink href="/" className="flex items-center gap-2">
        <NextImage
          ...
          src={"/LogoKantinku.png"}
          alt="Logo Kantinku"
          className="flex max-md:hidden items-center md:max-w-[50px]"
        />
        <p className="text-black font-bold text-2xl max-md:hidden">KantinKu</p>
      </UnstyledLink>
